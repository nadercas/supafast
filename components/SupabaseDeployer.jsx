  ...
  return (
    <div style={S.root}>
      ...
      <header style={S.header}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <a href="/self-hosting" style={{ fontSize: 11, color: C.dim, textDecoration: "none", padding: "4px 10px", borderRadius: 6, border: `1px solid ${C.border}`, background: C.surface, transition: "color 0.15s" }}
            onMouseEnter={(e) => e.target.style.color = C.text} onMouseLeave={(e) => e.target.style.color = C.dim}>
            Self-Hosting
          </a>
          <a href="https://github.com/nadercas/supafast" target="_blank" rel="noopener noreferrer"
            style={{ fontSize: 11, color: C.dim, textDecoration: "none", padding: "4px 10px", borderRadius: 6, border: `1px solid ${C.border}`, background: C.surface, display: "flex", alignItems: "center", gap: 6, transition: "color 0.15s" }}
            onMouseEnter={(e) => e.target.style.color = C.text} onMouseLeave={(e) => e.target.style.color = C.dim}>
